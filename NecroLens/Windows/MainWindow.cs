...
namespace NecroLens.Windows
{
    internal class MainWindow : Window
    {
        ...
        {
            var status = DungeonService.FloorDetails.CurrentTrapStatus();
        ...
        {
            ImGui.Text("Necrolens window is live!");
            PictoManager.TestCircle();
        }
